...
public record Organization(Optional<UUID>organizationId,Optional<String>description,String orgName,String documentPath,  Optional<String> createdAt,
                           Optional<String> updatedAt)
{
 ...
 public JsonObject toJson()
 {
     return new JsonObject()
             .put(Constants.ORG_ID,organizationId.map(UUID::toString).orElse(null))
    ...
    public Map<String, Object> toNonEmptyFieldsMap() {
        ...
        organizationId.ifPresent(id -> map.put(Constants.ORG_ID, id.toString()));
