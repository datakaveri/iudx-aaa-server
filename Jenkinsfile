        ...
        node('master') {
          script{
            ...
            catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE') {
              sh 'HTTP_PROXY=\'127.0.0.1:8090\' newman run /var/lib/jenkins/iudx/aaa-server/Newman/iudx-aaa-server.postman_collection.json -e /home/ubuntu/configs/iudx-aaa-server.postman_environment.json --insecure -r htmlextra --reporter-htmlextra-export /var/lib/jenkins/iudx/aaa-server/Newman/report/report.html'
            }
            runZapAttack()
          }
        }
        ...
        always{
          node('master') {
            script{
               ...
               publishHTML([allowMissing: false, alwaysLinkToLastBuild: true, keepAll: false, reportDir: '/var/lib/jenkins/iudx/aaa-server/Newman/report/', reportFiles: 'report.html', reportName: 'HTML Report', reportTitles: ''])
            }  
          }
        }
      }
