...
public class Constants {
  ...
  public static final String GET_RES_OWNER =
      "select id from users where email_hash = $1::text";
  ...
  public static final String GET_RES_SER_OWNER =
      "select a.id,url,a.owner_id from resource_server a inner join ";
  ...
  public static final String CHECK_RES_SER =
      "select url as cat_id,id from resource_server "
  ...
  public static final String RES_GRP_OWNER =
      "select provider_id from resource_group where "
          + "provider_id != $1::UUID  and cat_id = any($2::text[])";
  public static final String RES_OWNER =
      "select provider_id from resource where provider_id != $1::UUID"
          + " and cat_id = any($2::text[])";
  public static final String CHECK_DELEGATION =
      "Select a.id from delegations a inner join resource_server b "
  ...
  public static final String GET_RES_GRP_OWNER =
      "select cat_id,provider_id from resource_group where cat_id = any($1::text[])";

  public static final String GET_RES_OWNERS =
      "select cat_id,provider_id from resource where cat_id = any($1::text[])";

  public static final String GET_RES_DETAILS =
      "select cat_id,id from resource where cat_id = ANY($1::text[]) ";

  public static final String GET_RES_GRP_DETAILS =
      "select cat_id,id from resource_group where cat_id = ANY($1::text[]) ";
