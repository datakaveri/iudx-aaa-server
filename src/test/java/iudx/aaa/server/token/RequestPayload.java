...
public class RequestPayload {
  ...
  public static JsonObject revokeTokenValidPayload =
      new JsonObject()
          .put("clientId", "349b4b55-0251-490e-bee9-00f3a5d3e643")
          .put("rsUrl", "foobar.iudx.io");

  /* Payload for TIP */
  public static JsonObject expiredTipPayload =
      new JsonObject()
          .put(
              "accessToken",
              "eyJ0eXAiOiJKV1QiL"
  ...
  public static JsonObject randomToken =
      new JsonObject()
          .put(
              "accessToken",
