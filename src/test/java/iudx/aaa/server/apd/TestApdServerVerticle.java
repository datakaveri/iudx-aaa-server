...
/**
 * Dummy HTTP server used in {@link ApdWebClientTest} unit tests. Mimics bad HTTP responses from an
 * APD.
 */
        ...
        .handler(
            context -> {
              ...
              if (body.getJsonObject(APD_REQ_CONTEXT).containsKey("TestError")) {
                ...
                JsonObject jsonResponse =
                    new JsonObject()
                        ...
                        .put(APD_RESP_DETAIL, "Error")
                        .put(APD_RESP_SESSIONID, UUID.randomUUID().toString())
              ...
              // add else if allow with userClass
                ...
                JsonObject jsonResponse =
                    new JsonObject()
                        .put(APD_RESP_TYPE, APD_URN_ALLOW)
  ...
  private void postVerify(RoutingContext context, int counter) {
    ...
    switch (counter) {
      case 1:
        response
            .setStatusCode(200)
            .putHeader("Content-type", "application/html")
            .end("<html></html>");
        break;
      case 2:
        vertx.setTimer(
      ...
      case 21:
        ...
        jsonResponse =
            new JsonObject()
                ...
                .put(APD_RESP_SESSIONID, "something")
                .put(APD_RESP_DETAIL, "something")
                .put(APD_CONSTRAINTS, new JsonArray());
        response
            .setStatusCode(200)
            .putHeader("Content-type", "application/json")
            .end(jsonResponse.encode());
