...
public class KcAdmin {
   ...
   */
  public KcAdmin(
      String serverUrl, String realm, String clientId, String clientSecret, int poolSize) {
  ...
  /**
   * Find a user on Keycloak by email address. If the user is found, the name, keycloak ID and email
   * address is sent in a JSON object. Else, an empty JSON object is sent. Note that a user may
   * exist on Keycloak but may not have a user profile.
   *
