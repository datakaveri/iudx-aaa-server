...
public class ListPolicyNotificationTest {
    private static Logger LOGGER = LogManager.getLogger(iudx.aaa.server.policy.ListPolicyNotificationTest.class);
    ...
    @Test
    @DisplayName("List Policy Notification for Invalid User")
    void listPolicyNotification(VertxTestContext vertxTestContext){
        policyService.listPolicyNotification(createUser3,new JsonObject(),
   ...
   /* @Test
    @DisplayName("List Policy Notification for Invalid User")
    void listPolicyNotification1(VertxTestContext vertxTestContext){
        var jsonObjects = new JsonObject().put("providerId","844e251b-574b-46e6-9247-f76f1f70a637");
        policyService.listPolicyNotification(createUser4,jsonObjects,
                vertxTestContext.succeeding(response-> vertxTestContext.verify(()->{
                    //assertEquals(ERR_TITLE_INVALID_ROLES,response.getString("title"));
                    vertxTestContext.completeNow();
                })));
