...
"UPDATE apd_policies SET status = 'DELETED', updated_at = NOW() WHERE id = ANY($1::uuid[])";
  ...
  public static final String EMAIL_BODY =
      "Hello, \n \nA consumer ${CONSUMER_NAME},email ${CONSUMER_EMAIL} has requested access to your dataset ${REQUESTED_CAT_ID} . Please visit ${PUBLISHER_PANEL_URL} to approve/reject this request. \n \nRegards, \n${SENDER'S_NAME}";
