...
public class Constants {
  ...
  public static final String PROVIDER_PENDING_MESG =
      ", Provider registrations are pending approval by resource server admin";
  ...
  public static final String SUCC_TITLE_REGEN_CLIENT_SECRET =
      "Regenerated client secret for requested client ID";
  public static final String SUCC_TITLE_CREATED_DEFAULT_CLIENT =
      "Created default client credentials";
  ...
  public static final String ERR_TITLE_ROLE_FOR_RS_EXISTS =
      "Role for resource server already exists";
  ...
  public static final String ERR_TITLE_PENDING_REJECTED_PROVIDER_RS_REG_EXISTS =
      "Pending/Rejected provider registration for resource server";
  ...
  public static final String SQL_GET_PHONE = "SELECT phone FROM users WHERE id = $1::uuid";
  ...
  public static final String SQL_CHECK_DEFAULT_CLIENT_EXISTS =
      "SELECT client_id FROM user_clients WHERE user_id = $1::uuid AND client_name = '"
          + DEFAULT_CLIENT
          + "'";
