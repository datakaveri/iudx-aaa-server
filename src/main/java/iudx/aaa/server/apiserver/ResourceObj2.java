...
public class ResourceObj2 {
  ...
  public ResourceObj2(ItemType itemType, UUID id, UUID ownerId, String resServerUrl, UUID resGrpId,
  ...
  public static class ResourceObjBuilder
  {
    ...
    public ResourceObj2 build() {
      return new ResourceObj2(this.itemType, this.id, this.ownerId, this.resServerUrl,
