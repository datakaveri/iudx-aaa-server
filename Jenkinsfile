    ...
    stage('Integration Test & OWASP ZAP pen test'){
      ...
      post{
        ...
        cleanup{
          ...
          cleanWs deleteDirs: true, disableDeferredWipeout: true, patterns: [[pattern: 'src/main/resources/db/migration/V?__Add_Integration_Test_data.sql', type: 'INCLUDE'],[pattern: 'target/', type: 'INCLUDE']]
        }
      }
    }
